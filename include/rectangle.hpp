...
bool xy_rect::hit(const ray& r, const float t0, const float t1, hit_record& rec) const {
...
bool xz_rect::hit(const ray& r, const float t0, const float t1, hit_record& rec) const {
...
bool yz_rect::hit(const ray& r, const float t0, const float t1, hit_record& rec) const {
